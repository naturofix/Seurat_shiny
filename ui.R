...
shinyUI(fluidPage(
  ...
  fluidRow(
    uiOutput('debug_ui'),
    column(4,uiOutput('select_dataset_ui')),
    column(4,uiOutput('reduce_dataset_select_ui')),
    column(4,radioButtons('save_rds_rb','Save after every step',c(F,T))),
                                     ...
                                     tabPanel('Filtering and Normalisation',
                                              ...
                                              tabsetPanel(
                                                tabPanel('Create Seurat Object',
                                                         ...
                                                         column(6,radioButtons('run_reduce_rb','Reduce Data',c(F,T))),
